<%@ Page Language="VB" AutoEventWireup="false" CodeFile="SendMMS.aspx.vb" Inherits="SendMMS" %>
                            ...
                            <table id="tblMain" border="0" cellpadding="1" cellspacing="1" 
                                ...
                                <tr style="color: #000000; text-decoration: underline">
                                    ...
                                    <td style="width: 919px" valign="top">
                                        ...
                                        &nbsp;<asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="Data Source=LCTSMS;Initial Catalog=LCTBulkSMS;Persist Security Info=True;User ID=sa;password=Sms123$;Connect Timeout=300;Max Pool Size=32000"
